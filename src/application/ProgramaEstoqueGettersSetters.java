...
public class ProgramaEstoqueGettersSetters {
...
//				Product2 product = new Product2(); .. Como a gente fez um Construtor na classe Profuct2, não precisa instanciar ele aqui. E sim no fim.
		...
		// abaixo temos prints só pra mostrar que o prodct está sendo uma variável com
		// valores vazios
...
//				System.out.println(product.quantity);
		...
		Product2 product = new Product2(name, price, quantity); // o construtor serve para proteger com que a classe não
																// fique sem valores

		// product.toString(product) -> essa aqui, assim como várias outras, são
		// operações padrões de um OBJETO.
		System.out.printf("\nProduct data: " + product); // aqui o certo seria colocar entr (product.toString()), mas
															// por ser println, só colocar a classe já serve
